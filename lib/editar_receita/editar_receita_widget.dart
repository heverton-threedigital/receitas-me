...
import '/components/form_ingredientes_widget.dart';
...
import 'editar_receita_model.dart';
export 'editar_receita_model.dart';

/// Página de cadastro de receitas
class EditarReceitaWidget extends StatefulWidget {
  const EditarReceitaWidget({
    super.key,
...
class _EditarReceitaWidgetState extends State<EditarReceitaWidget> {
  late EditarReceitaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarReceitaModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ReceitasDetalhadasRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReceitasDetalhadasRow> editarReceitaReceitasDetalhadasRowList =
            snapshot.data!;

        final editarReceitaReceitasDetalhadasRow =
            editarReceitaReceitasDetalhadasRowList.isNotEmpty
                ? editarReceitaReceitasDetalhadasRowList.first
                : null;
                                                ...
                                                children: [
                                                    ...
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        await action_blocks
                                                          ...
                                                          context,
                                                          idReceita:
                                                              editarReceitaReceitasDetalhadasRow
                                                                  ?.id,
                                                          imagemReceita:
                                                              editarReceitaReceitasDetalhadasRow
                                                                  ?.imagemUrl,
                                                  ...
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      ...
                                                      if (!((editarReceitaReceitasDetalhadasRow
                                                                      ?.imagemUrl !=
                                                                  null &&
                                                              editarReceitaReceitasDetalhadasRow
                                                                      ?.imagemUrl !=
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              valueOrDefault<
                                                                  String>(
                                                                '@${editarReceitaReceitasDetalhadasRow?.autorUsuario}',
                                                                '-',
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                                  .dscricaoReceitaTextController ??=
                                                              TextEditingController(
                                                            text: editarReceitaReceitasDetalhadasRow
                                                                ?.receitaDescricao,
                                                          ),
                                                          focusNode: _model
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        return FlutterFlowDropDown<
                                                            String>(
                                                          controller: _model
                                                                  .categoriaReceitaValueController ??=
                                                              FormFieldController<
                                                                  String>(
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            _model.porcoesReceitaTextController ??=
                                                                                TextEditingController(
                                                                          text:
                                                                              editarReceitaReceitasDetalhadasRow?.porcoes,
                                                                        ),
                                                                        focusNode:
                                                                            _model.porcoesReceitaFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        obscureText:
                                                                            false,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          controller: _model.preparacaoReceitaTextController ??=
                                                                              TextEditingController(
                                                                            text:
                                                                                editarReceitaReceitasDetalhadasRow?.tempoPreparo?.toString(),
                                                                          ),
                                                                          focusNode:
                                                                              _model.preparacaoReceitaFocusNode,
                                                                          autofocus:
                                                                              false,
                                                                          obscureText:
                                                                              false,
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              key: Key(
                                                                  'Keyzua_${listViewIndex}_of_${listViewIngredientesRowList.length}'),
                                                              valorInicial:
                                                ...
                                                FutureBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return ListView.separated(
                                                      ...
                                                      itemBuilder: (context,
                                                          listViewIndex) {
                                                        final listViewInstrucoesRow =
                                                            listViewInstrucoesRowList[
                                                                listViewIndex];
                                                        return Container(
                                                          child: PassosWidget(
                                                            key: Key(
                                                                'Keylmv_${listViewIndex}_of_${listViewInstrucoesRowList.length}'),
                                                            valorInicial: _model
                                                                .passos
                                                                .elementAtOrNull(
                                                                    FFAppState()
