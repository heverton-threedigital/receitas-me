...
class EditarReceitaWidget extends StatefulWidget {
  ...
  final ReceitasDetalhadasRow? receita;
...
class _EditarReceitaWidgetState extends State<EditarReceitaWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.imagemReceitaURL = widget.receita?.imagemUrl;
      safeSetState(() {});
    });
    ...
    _model.dscricaoReceitaTextController ??=
        TextEditingController(text: widget.receita?.receitaDescricao);
    _model.dscricaoReceitaFocusNode ??= FocusNode();

    _model.porcoesReceitaTextController ??=
        TextEditingController(text: widget.receita?.porcoes);
    _model.porcoesReceitaFocusNode ??= FocusNode();

    _model.preparacaoReceitaTextController ??=
        TextEditingController(text: widget.receita?.tempoPreparo?.toString());
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  _model.addToListaIngredientesTextos(
                                      ...
                                      child: Form(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            FutureBuilder<List<InstrucoesRow>>(
                                              future:
                                                  InstrucoesTable().queryRows(
                                                queryFn: (q) => q.eqOrNull(
                                                  'receita_id',
                                                  widget.receita?.id,
                                                ),
