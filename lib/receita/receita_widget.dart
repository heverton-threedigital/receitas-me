...
class ReceitaWidget extends StatefulWidget {
  ...
  static String routePath = 'receita/:slug';
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Text(
                                                                                      '@${receitaReceitasDetalhadasRow?.autorUsuario}',
                                                              ...
                                                              Expanded(
                                                                child: Builder(
                                                                  builder:
                                                                      (context) {
                                                                    final ingredientes =
                                                                        receitaReceitasDetalhadasRow?.ingredientes?.toList() ??
                                                                            [];
                                                                    ...
                                                                    return ListView
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        final ingredientesItem =
                                                                            ingredientes[ingredientesIndex];
                                                                        return Padding(
                                                                          padding: EdgeInsetsDirectional.fromSTEB(
                                                                              0.0,
                                                                              0.0,
                                                              ...
                                                              Expanded(
                                                                child: Builder(
                                                                  builder:
                                                                      (context) {
                                                                    final passos =
                                                                        receitaReceitasDetalhadasRow?.instrucoes?.toList() ??
                                                                            [];
